...
namespace _03Project.DataAccessLayer.Migrations
{
    ...
    [Migration("20240126090529_init3")]
    partial class init3
    {
            ...
            modelBuilder.Entity("_06Project.Entities.Concrete.Food", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Calorie = 1000,
                            Carbs = 500,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6625),
                            DataStatus = 0,
                        ...
                        new
                        {
                            ...
                            Calorie = 1200,
                            Carbs = 600,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6627),
                            DataStatus = 0,
            ...
            modelBuilder.Entity("_06Project.Entities.Concrete.MealTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6616),
                            DataStatus = 0,
                            MealName = "Breakfast"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6617),
                            DataStatus = 0,
                            MealName = "Lunch"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6618),
                            DataStatus = 0,
                            MealName = "Dinner"
                        });
                });
            ...
            modelBuilder.Entity("_06Project.Entities.Concrete.PortionSize", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6547),
                            DataStatus = 0,
                            PortionInGrams = 100
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6557),
                            DataStatus = 0,
                            PortionInGrams = 120
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2024, 1, 26, 12, 5, 29, 441, DateTimeKind.Local).AddTicks(6558),
                            DataStatus = 0,
                            PortionInGrams = 140
                        });
                });
